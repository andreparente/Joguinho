...
class Level
{
    ...
    func createLevelNeptune() {
        ...
        case 8:
            ...
            self.gems.append(CGPoint(x: 15*screenSize.width, y: 4*screenSize.height/8))
    ...
    func createLevelUranus() {
        ...
        case 1:
            ...
            self.gems.append(CGPoint(x: 10.4*screenSize.width, y: 4*screenSize.height/8))
        ...
        case 2:
            self.rocks.append(CGPoint(x: 0.3*screenSize.width, y: 4.5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 0.9*screenSize.width, y: 6*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.2*screenSize.width, y: 7.5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.3*screenSize.width, y: 1.2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.4*screenSize.width, y: 4.27673700651*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.9*screenSize.width, y: 6.0556826209909*screenSize.height/8))
            self.rocks.append(CGPoint(x: 2.5*screenSize.width, y: 4.0886113625432*screenSize.height/8))
            self.rocks.append(CGPoint(x: 3.0*screenSize.width, y: 7.1984189521514*screenSize.height/8))
            self.rocks.append(CGPoint(x: 3.5*screenSize.width, y: 2.6060246353066*screenSize.height/8))
            self.rocks.append(CGPoint(x: 4.2*screenSize.width, y: 4.1419960726714*screenSize.height/8))
            self.rocks.append(CGPoint(x: 5.0*screenSize.width, y: 1.6677675739246*screenSize.height/8))
            self.rocks.append(CGPoint(x: 5.7*screenSize.width, y: 2.6424171080079*screenSize.height/8))
            self.rocks.append(CGPoint(x: 6.5*screenSize.width, y: 5.2726118253882*screenSize.height/8))
            self.rocks.append(CGPoint(x: 7.2*screenSize.width, y: 3*screenSize.height/8))
            self.rocks.append(CGPoint(x: 7.6*screenSize.width, y: 7.8*screenSize.height/8))
            self.rocks.append(CGPoint(x: 7.8*screenSize.width, y: 1.1*screenSize.height/8))
            self.rocks.append(CGPoint(x: 8.3*screenSize.width, y: 2.6355860953385*screenSize.height/8))
            self.rocks.append(CGPoint(x: 8.7*screenSize.width, y: 3.5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 9.5*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 10*screenSize.width, y: 2.5*screenSize.height/8))
            self.gems.append(CGPoint(x: screenSize.width, y: 4.2*screenSize.height/2))
            self.gems.append(CGPoint(x: screenSize.width/2, y: 6.5*screenSize.height/8))
            self.gems.append(CGPoint(x: 2*screenSize.width, y: 7*screenSize.height/8))
            self.gems.append(CGPoint(x: 3.5*screenSize.width, y: 4.5*screenSize.height/8))
            self.gems.append(CGPoint(x: 5*screenSize.width, y: 5.4*screenSize.height/8))
            self.gems.append(CGPoint(x: 7*screenSize.width, y: 4*screenSize.height/8))
            self.gems.append(CGPoint(x: 9*screenSize.width, y: 1*screenSize.height/8))
            self.gems.append(CGPoint(x: 10.3*screenSize.width, y: 4*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 1.1*screenSize.width, y: 7*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 3.5*screenSize.width, y: 1.5*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 5.9*screenSize.width, y: 2*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 8.5*screenSize.width, y: 4*screenSize.height/8))
        case 3:
            self.rocks.append(CGPoint(x: 0.3*screenSize.width, y: 1.2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 0.9*screenSize.width, y: 7.5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.2*screenSize.width, y: 3*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.3*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.4*screenSize.width, y: 4.27673700651*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.9*screenSize.width, y: 6.0556826209909*screenSize.height/8))
            self.rocks.append(CGPoint(x: 2.5*screenSize.width, y: 4.0886113625432*screenSize.height/8))
            self.rocks.append(CGPoint(x: 3.0*screenSize.width, y: 7.1984189521514*screenSize.height/8))
            ...
            self.rocks.append(CGPoint(x: 5.7*screenSize.width, y: 2.6424171080079*screenSize.height/8))
            self.rocks.append(CGPoint(x: 6.5*screenSize.width, y: 5.2726118253882*screenSize.height/8))
            self.rocks.append(CGPoint(x: 7.2*screenSize.width, y: 7*screenSize.height/8))
            self.rocks.append(CGPoint(x: 7.6*screenSize.width, y: 7.8*screenSize.height/8))
            self.rocks.append(CGPoint(x: 7.8*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 8.3*screenSize.width, y: 2.6355860953385*screenSize.height/8))
            self.rocks.append(CGPoint(x: 8.7*screenSize.width, y: 3.5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 9.5*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 9.9*screenSize.width, y: 2.5*screenSize.height/8))
            self.gems.append(CGPoint(x: 0.4*screenSize.width, y: 4.2*screenSize.height/2))
            self.gems.append(CGPoint(x: screenSize.width, y: 6.5*screenSize.height/8))
            self.gems.append(CGPoint(x: 2.2*screenSize.width, y: 7*screenSize.height/8))
            self.gems.append(CGPoint(x: 3*screenSize.width, y: 4.5*screenSize.height/8))
            self.gems.append(CGPoint(x: 4.5*screenSize.width, y: 5.4*screenSize.height/8))
            self.gems.append(CGPoint(x: 7*screenSize.width, y: 4*screenSize.height/8))
            self.gems.append(CGPoint(x: 7.5*screenSize.width, y: 1*screenSize.height/8))
            self.gems.append(CGPoint(x: 10.2*screenSize.width, y: 4*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 2*screenSize.width, y: 5*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 4*screenSize.width, y: 2*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 6*screenSize.width, y: 3*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 9*screenSize.width, y: 4*screenSize.height/8))
        case 4:
            self.rocks.append(CGPoint(x: 0.3*screenSize.width, y: 1.2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 0.7*screenSize.width, y: 7.5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1*screenSize.width, y: 3*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.1*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.2*screenSize.width, y: 5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.7*screenSize.width, y: 6.0556826209909*screenSize.height/8))
            self.rocks.append(CGPoint(x: 2.2*screenSize.width, y: 4.0886113625432*screenSize.height/8))
            self.rocks.append(CGPoint(x: 2.8*screenSize.width, y: 7.1984189521514*screenSize.height/8))
            self.rocks.append(CGPoint(x: 3.3*screenSize.width, y: 2.6060246353066*screenSize.height/8))
            self.rocks.append(CGPoint(x: 4*screenSize.width, y: 4.1419960726714*screenSize.height/8))
            self.rocks.append(CGPoint(x: 4.7*screenSize.width, y: 1.6677675739246*screenSize.height/8))
            self.rocks.append(CGPoint(x: 5*screenSize.width, y: 2.6424171080079*screenSize.height/8))
            self.rocks.append(CGPoint(x: 5.5*screenSize.width, y: 5.2726118253882*screenSize.height/8))
            self.rocks.append(CGPoint(x: 6*screenSize.width, y: 7*screenSize.height/8))
            self.rocks.append(CGPoint(x: 6.4*screenSize.width, y: 7.8*screenSize.height/8))
            self.rocks.append(CGPoint(x: 6.6*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 6.9*screenSize.width, y: 1.5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 7.3*screenSize.width, y: 3.5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 7.5*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 8*screenSize.width, y: 2.5*screenSize.height/8))
            self.gems.append(CGPoint(x: 0.6*screenSize.width, y: 1.5*screenSize.height/2))
            self.gems.append(CGPoint(x: screenSize.width, y: 3.5*screenSize.height/8))
            self.gems.append(CGPoint(x: 1.6*screenSize.width, y: 6.5*screenSize.height/8))
            self.gems.append(CGPoint(x: 3*screenSize.width, y: 3.2*screenSize.height/8))
            self.gems.append(CGPoint(x: 4.5*screenSize.width, y: 4*screenSize.height/8))
            self.gems.append(CGPoint(x: 6*screenSize.width, y: 5*screenSize.height/8))
            self.gems.append(CGPoint(x: 6.5*screenSize.width, y: 2.3*screenSize.height/8))
            self.gems.append(CGPoint(x: 7.5*screenSize.width, y: 4*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 1*screenSize.width, y: 7*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 3*screenSize.width, y: 4*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 5*screenSize.width, y: 6*screenSize.height/8))
        case 5:
            self.rocks.append(CGPoint(x: 0.5*screenSize.width, y: 1.2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 0.7*screenSize.width, y: 7.6*screenSize.height/8))
            self.rocks.append(CGPoint(x: 0.9*screenSize.width, y: 2.2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.3*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.1*screenSize.width, y: 6.6*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.7*screenSize.width, y: 6.0556826209909*screenSize.height/8))
            self.rocks.append(CGPoint(x: 2.2*screenSize.width, y: 4.0886113625432*screenSize.height/8))
            self.rocks.append(CGPoint(x: 2.8*screenSize.width, y: 7.1984189521514*screenSize.height/8))
            self.rocks.append(CGPoint(x: 3.3*screenSize.width, y: 2.6060246353066*screenSize.height/8))
            ...
            self.rocks.append(CGPoint(x: 5*screenSize.width, y: 2.6424171080079*screenSize.height/8))
            self.rocks.append(CGPoint(x: 5.5*screenSize.width, y: 5.2726118253882*screenSize.height/8))
            self.rocks.append(CGPoint(x: 6*screenSize.width, y: 2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 6.2*screenSize.width, y: 3*screenSize.height/8))
            self.rocks.append(CGPoint(x: 6.4*screenSize.width, y: 6*screenSize.height/8))
            self.rocks.append(CGPoint(x: 6.6*screenSize.width, y: 5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 7*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 7.5*screenSize.width, y: 2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 8*screenSize.width, y: 3*screenSize.height/8))
            self.gems.append(CGPoint(x: 0.6*screenSize.width, y: 1.5*screenSize.height/2))
            self.gems.append(CGPoint(x: screenSize.width, y: 3.5*screenSize.height/8))
            self.gems.append(CGPoint(x: 1.6*screenSize.width, y: 6.5*screenSize.height/8))
            self.gems.append(CGPoint(x: 3*screenSize.width, y: 3.2*screenSize.height/8))
            self.gems.append(CGPoint(x: 4.5*screenSize.width, y: 4*screenSize.height/8))
            self.gems.append(CGPoint(x: 6*screenSize.width, y: 5*screenSize.height/8))
            self.gems.append(CGPoint(x: 7.2*screenSize.width, y: 4*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 1*screenSize.width, y: 7*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 3*screenSize.width, y: 4*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 5*screenSize.width, y: 6*screenSize.height/8))
        case 6:
            self.rocks.append(CGPoint(x: 0.4*screenSize.width, y: 1*screenSize.height/8))
            self.rocks.append(CGPoint(x: 0.6*screenSize.width, y: 2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 0.8*screenSize.width, y: 3*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.2*screenSize.width, y: 5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.4*screenSize.width, y: 6*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.6*screenSize.width, y: 7*screenSize.height/8))
            self.rocks.append(CGPoint(x: 2.3*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 2.9*screenSize.width, y: 5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 3.7*screenSize.width, y: 2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 4.5*screenSize.width, y: 3*screenSize.height/8))
            self.rocks.append(CGPoint(x: 5*screenSize.width, y: 6*screenSize.height/8))
            self.rocks.append(CGPoint(x: 5.5*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 6*screenSize.width, y: 2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 6.2*screenSize.width, y: 7*screenSize.height/8))
            self.rocks.append(CGPoint(x: 6.4*screenSize.width, y: 6*screenSize.height/8))
            self.rocks.append(CGPoint(x: 6.6*screenSize.width, y: 5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 7*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 7.3*screenSize.width, y: 2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 7.6*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 7.8*screenSize.width, y: 6*screenSize.height/8))
            self.rocks.append(CGPoint(x: 8*screenSize.width, y: 2.5*screenSize.height/8))
            self.gems.append(CGPoint(x: 0.6*screenSize.width, y: 1.5*screenSize.height/2))
            self.gems.append(CGPoint(x: screenSize.width, y: 3.5*screenSize.height/8))
            self.gems.append(CGPoint(x: 1.6*screenSize.width, y: 6.5*screenSize.height/8))
            ...
            self.gems.append(CGPoint(x: 7.2*screenSize.width, y: 4*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 1*screenSize.width, y: 7*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 3*screenSize.width, y: 3*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 5*screenSize.width, y: 4*screenSize.height/8))
        case 7:
            self.rocks.append(CGPoint(x: 0.3*screenSize.width, y: 1.5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 0.5*screenSize.width, y: 3.2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 0.7*screenSize.width, y: 2.3*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.3*screenSize.width, y: 6*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.6*screenSize.width, y: 5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.9*screenSize.width, y: 7*screenSize.height/8))
            self.rocks.append(CGPoint(x: 2.2*screenSize.width, y: 3.3*screenSize.height/8))
            self.rocks.append(CGPoint(x: 2.4*screenSize.width, y: 5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 2.7*screenSize.width, y: 7*screenSize.height/8))
            self.rocks.append(CGPoint(x: 3*screenSize.width, y: 2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 3.3*screenSize.width, y: 5.5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 3.6*screenSize.width, y: 3.5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 3.9*screenSize.width, y: 7*screenSize.height/8))
            self.rocks.append(CGPoint(x: 4.4*screenSize.width, y: 2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 5*screenSize.width, y: 3.8*screenSize.height/8))
            self.rocks.append(CGPoint(x: 5.5*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 5.6*screenSize.width, y: 6*screenSize.height/8))
            self.rocks.append(CGPoint(x: 5.8*screenSize.width, y: 5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 6*screenSize.width, y: 2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 6.3*screenSize.width, y: 7*screenSize.height/8))
            self.rocks.append(CGPoint(x: 6.6*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 7*screenSize.width, y: 6*screenSize.height/8))
            self.rocks.append(CGPoint(x: 7.4*screenSize.width, y: 2.5*screenSize.height/8))
            self.gems.append(CGPoint(x: 0.6*screenSize.width, y: 1.5*screenSize.height/2))
            self.gems.append(CGPoint(x: screenSize.width, y: 3.5*screenSize.height/8))
            self.gems.append(CGPoint(x: 1.6*screenSize.width, y: 6.5*screenSize.height/8))
            self.gems.append(CGPoint(x: 3*screenSize.width, y: 3.2*screenSize.height/8))
            self.gems.append(CGPoint(x: 4.5*screenSize.width, y: 4*screenSize.height/8))
            self.gems.append(CGPoint(x: 6*screenSize.width, y: 5*screenSize.height/8))
            self.gems.append(CGPoint(x: 6.5*screenSize.width, y: 4*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 1*screenSize.width, y: 7*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 3.5*screenSize.width, y: 3.9*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 5*screenSize.width, y: 4*screenSize.height/8))
        case 8:
            self.rocks.append(CGPoint(x: 0.4*screenSize.width, y: 1*screenSize.height/8))
            self.rocks.append(CGPoint(x: 0.6*screenSize.width, y: 2*screenSize.height/8))
            ...
            self.rocks.append(CGPoint(x: 1.4*screenSize.width, y: 6*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.6*screenSize.width, y: 7*screenSize.height/8))
            self.rocks.append(CGPoint(x: 1.8*screenSize.width, y: 7*screenSize.height/8))
            self.rocks.append(CGPoint(x: 2*screenSize.width, y: 6*screenSize.height/8))
            self.rocks.append(CGPoint(x: 2.2*screenSize.width, y: 5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 2.4*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 2.6*screenSize.width, y: 3*screenSize.height/8))
            self.rocks.append(CGPoint(x: 2.8*screenSize.width, y: 2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 3*screenSize.width, y: 2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 3.2*screenSize.width, y: 3*screenSize.height/8))
            self.rocks.append(CGPoint(x: 3.4*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 3.6*screenSize.width, y: 5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 3.8*screenSize.width, y: 6*screenSize.height/8))
            self.rocks.append(CGPoint(x: 4*screenSize.width, y: 7*screenSize.height/8))
            self.rocks.append(CGPoint(x: 4.2*screenSize.width, y: 7*screenSize.height/8))
            self.rocks.append(CGPoint(x: 4.4*screenSize.width, y: 6*screenSize.height/8))
            self.rocks.append(CGPoint(x: 4.6*screenSize.width, y: 5*screenSize.height/8))
            self.rocks.append(CGPoint(x: 4.8*screenSize.width, y: 4*screenSize.height/8))
            self.rocks.append(CGPoint(x: 5*screenSize.width, y: 3*screenSize.height/8))
            self.rocks.append(CGPoint(x: 5.2*screenSize.width, y: 2*screenSize.height/8))
            self.rocks.append(CGPoint(x: 5.4*screenSize.width, y: 4*screenSize.height/8))
            self.gems.append(CGPoint(x: 0.4*screenSize.width, y: 1.5*screenSize.height/2))
            self.gems.append(CGPoint(x: 0.7*screenSize.width, y: 3.5*screenSize.height/8))
            self.gems.append(CGPoint(x: 1*screenSize.width, y: 6.5*screenSize.height/8))
            self.gems.append(CGPoint(x: 2*screenSize.width, y: 3.2*screenSize.height/8))
            self.gems.append(CGPoint(x: 3*screenSize.width, y: 4*screenSize.height/8))
            self.gems.append(CGPoint(x: 4*screenSize.width, y: 5*screenSize.height/8))
            self.gems.append(CGPoint(x: 5*screenSize.width, y: 4*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 0.6*screenSize.width, y: 7*screenSize.height/8))
            self.fueldrops.append(CGPoint(x: 0.4*screenSize.width, y: 3*screenSize.height/8))
        default:
        break
        }
    }
